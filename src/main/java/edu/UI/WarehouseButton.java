...
public class WarehouseButton extends Button {
    ...
    public static WarehouseButton action(String text, double width, double height, boolean accent) {
        String base = accent
                ? "-fx-background-color: linear-gradient(to right, #F35621, #EEAE3F); -fx-background-radius: 8; -fx-cursor: hand;"
                : "-fx-background-color: rgba(217,217,217,0.27); -fx-background-radius: 8; -fx-cursor: hand;";
        String hover = accent
                ? "-fx-background-color: linear-gradient(to right, #E04A18, #DDA035); -fx-background-radius: 8; -fx-cursor: hand;"
                : "-fx-background-color: rgba(217,217,217,0.4); -fx-background-radius: 8; -fx-cursor: hand;";
    ...
    public static WarehouseButton nav(String arrow) {
        String base  = "-fx-background-color: rgba(217,217,217,0.27); -fx-background-radius: 8; -fx-cursor: hand;";
        String hover = "-fx-background-color: rgba(217,217,217,0.4);  -fx-background-radius: 8; -fx-cursor: hand;";
        WarehouseButton btn = new WarehouseButton(arrow, base, hover);
        btn.setPrefSize(58, 60);
        btn.setFont(Font.font("IBM Plex Mono", 20));
        btn.setTextFill(Color.web("#FFF6F6"));
        btn.setEffect(new DropShadow(4.8, 4, 5, Color.web("#000000", 0.25)));
        return btn;
    }
    ...
    public static WarehouseButton primary(String text) {
        String base  = "-fx-background-color: #F35621; -fx-text-fill: white; -fx-font-family: 'Monospaced'; -fx-font-size: 14px; -fx-padding: 10 24; -fx-cursor: hand;";
        String hover = "-fx-background-color: #E04A18; -fx-text-fill: white; -fx-font-family: 'Monospaced'; -fx-font-size: 14px; -fx-padding: 10 24; -fx-cursor: hand;";
